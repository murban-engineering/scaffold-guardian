  ...
  <div class="page-header">
    <div style="display:flex;align-items:center;justify-content:space-between;">
      <div style="display:flex;align-items:center;gap:8px;">
        <img src="${window.location.origin}/otnologo-removebg-preview.png" alt="OTNO" style="width:72px;height:auto;"/>
        <div>
    ...
    <div class="hq-page2">
      ...
      <div class="hq-page2-footer">
        <div class="hq-footer-brand">
          ...
          <img src="${window.location.origin}/otnologo-removebg-preview.png" alt="OTNO" style="width:80px;height:auto;filter:brightness(0);"/>
        </div>
