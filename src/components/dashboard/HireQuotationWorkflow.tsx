...
const HireQuotationWorkflow = ({
  ...
  const handleSelectPreviousClient = (quotation: HireQuotation) => {
    ...
    // Keep the test quotation's client ID when promoting — only the HSQ number is newly generated.
    ...
    setHeader((prev) => ({
      ...
      // From quotation (higher priority) — preserve the test quotation's client ID
